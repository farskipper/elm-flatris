	...
	return A2(
		_elm_lang$html$Html$button,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'background', 'transparent'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'border', '1px solid black'),
						_1: {
							ctor: '::',
							_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'border-radius', '20px'),
							_1: {
								ctor: '::',
								_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'color', 'black'),
								_1: {
									ctor: '::',
															...
															_1: {
																...
																_1: {
																	...
																	_1: {
																		...
																		_1: {
																			ctor: '::',
																			_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'position', 'fixed'),
																			_1: {
																				ctor: '::',
																				_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'top', '20px'),
																				_1: {
																					ctor: '::',
																					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'right', '20px'),
																					_1: {ctor: '[]'}
																				}
																			}
																		}
	...
	return A2(
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _w0rm$elm_flatris$View$renderCount(_p13.score),
					_1: {
						ctor: '::',
						_0: _w0rm$elm_flatris$View$renderLabel('Lines Cleared'),
						_1: {
							ctor: '::',
							_0: _w0rm$elm_flatris$View$renderCount(_p13.lines),
							_1: {
								ctor: '::',
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _w0rm$elm_flatris$View$renderNext(_p13.next),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
						...
						_1: {
							...
							_1: {
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'flex-flow', _1: 'row nowrap'},
										_1: {
											ctor: '::',
	...
	return A2(
		_elm_lang$html$Html$div,
		{
			...
			_0: _elm_lang$html$Html_Attributes$style(
				{
					ctor: '::',
					_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'padding', '10px'),
					_1: {
						ctor: '::',
						_0: A2(_w0rm$elm_flatris$View_ops['=>'], 'overflow', 'hidden'),
						_1: {ctor: '[]'}
					}
				}),
			_1: {
		...
		},
		{
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: _w0rm$elm_flatris$View$renderGameButton(model.state),
					_1: {ctor: '[]'}
				}
			}
		});
